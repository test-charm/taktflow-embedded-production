...
/**
 * One phase of the FZC heartbeat harness script. All fields are boxed so
...
public class FzcHeartbeatPhase {
    ...
    private Integer vehicleState;    // RTE FZC_SIG_VEHICLE_STATE read at TX boundary
    private Integer faultMask;       // RTE FZC_SIG_FAULT_MASK read at TX boundary (bit8=bus-off)
}
