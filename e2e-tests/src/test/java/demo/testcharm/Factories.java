...
import demo.testcharm.dto.RzcEncoderSetup;
import demo.testcharm.dto.RzcSchedulerSetup;
import demo.testcharm.dto.RzcHeartbeatSetup;
import demo.testcharm.dto.RzcSafetySetup;
import demo.testcharm.dto.RzcSelfTestSetup;
...
public class Factories {
    ...
    public JFactory factorySet(@Lazy RestfulStep restfulStep) {
        return new EntityFactory(new CompositeDataRepository(new MemoryDataRepository())
                ...
                .registerByType(RzcSchedulerSetup.class, new RzcSchedulerSetupDataRepository(restfulStep))
                .registerByType(RzcEncoderSetup.class, new RzcEncoderSetupDataRepository(restfulStep))
                .registerByType(RzcSafetySetup.class, new RzcSafetySetupDataRepository(restfulStep))
                .registerByType(RzcSelfTestSetup.class, new RzcSelfTestSetupDataRepository(restfulStep))
                .registerByType(RzcHeartbeatSetup.class, new RzcHeartbeatSetupDataRepository(restfulStep))
    ...
    public static class FzcSchedulerSetupDataRepository extends MemoryDataRepository {

        private final RestfulStep restfulStep;

        public FzcSchedulerSetupDataRepository(RestfulStep restfulStep) {
            this.restfulStep = restfulStep;
        }
        ...
        public void save(Object object) {
            super.save(object);
            restfulStep.postObjectInJson("/api/test/asw/fzc/scheduler/setup", object);
        }
    }

    public static class RzcSchedulerSetupDataRepository extends MemoryDataRepository {

        private final RestfulStep restfulStep;

        public RzcSchedulerSetupDataRepository(RestfulStep restfulStep) {
            this.restfulStep = restfulStep;
        }
        ...
        public void save(Object object) {
            super.save(object);
            restfulStep.postObjectInJson("/api/test/asw/rzc/scheduler/setup", object);
        }
    }
    ...
    public static class RzcEncoderSetupDataRepository extends MemoryDataRepository {

        private final RestfulStep restfulStep;

        public RzcEncoderSetupDataRepository(RestfulStep restfulStep) {
            this.restfulStep = restfulStep;
        }
        ...
        public void save(Object object) {
            super.save(object);
            restfulStep.postObjectInJson("/api/test/asw/rzc/encoder/setup", object);
        }
    }

    public static class RzcHeartbeatSetupDataRepository extends MemoryDataRepository {

        private final RestfulStep restfulStep;

        public RzcHeartbeatSetupDataRepository(RestfulStep restfulStep) {
            this.restfulStep = restfulStep;
        }
        ...
        public void save(Object object) {
            super.save(object);
            restfulStep.postObjectInJson("/api/test/asw/rzc/heartbeat/setup", object);
        }
    }
    ...
    public static class RzcSafetySetupDataRepository extends MemoryDataRepository {

        private final RestfulStep restfulStep;

        public RzcSafetySetupDataRepository(RestfulStep restfulStep) {
            this.restfulStep = restfulStep;
        }
        ...
        public void save(Object object) {
            super.save(object);
            restfulStep.postObjectInJson("/api/test/asw/rzc/safety/setup", object);
        }
    }

    public static class RzcSelfTestSetupDataRepository extends MemoryDataRepository {

        private final RestfulStep restfulStep;

        public RzcSelfTestSetupDataRepository(RestfulStep restfulStep) {
            this.restfulStep = restfulStep;
        }
        ...
        public void save(Object object) {
            super.save(object);
            restfulStep.postObjectInJson("/api/test/asw/rzc/selftest/setup", object);
        }
    }
}
