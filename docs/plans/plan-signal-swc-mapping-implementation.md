...
**Non-goal:** This planning change does not implement the schema, parser,
mapping, migration, generated output, or heuristic removal.
...
No production implementation may begin until the owner approves this plan.
Approval of the memo authorized planning, not code, schema, sidecar,
generated-file or CI changes. Each phase begins with tests observed failing,
ends with its named gates green, and is committed before the next phase.
...
### SM0 - Freeze baseline and inventory - PENDING
