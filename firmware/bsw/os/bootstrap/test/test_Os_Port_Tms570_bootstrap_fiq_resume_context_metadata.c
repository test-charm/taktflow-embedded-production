/**
 * @file    test_Os_Port_Tms570_bootstrap_fiq_resume_context_metadata.c
 * @brief   FIQ resume metadata sync tests for packed restored context
 * @date    2026-03-14
 */
#include "test_Os_Port_Tms570_bootstrap_support.h"

void test_Os_Port_Tms570_fiq_resume_uses_packed_restored_context_metadata_not_saved_frame_metadata(void)
{
    ...
    TEST_ASSERT_EQUAL_UINT32(0x31323334u, (uint32)state->LastRestoredTaskReturnAddress);
    TEST_ASSERT_EQUAL_HEX32(0x7E100013u, state->LastRestoredTaskCpsr);
    TEST_ASSERT_EQUAL_UINT32(0u, state->LastRestoredTaskIrqScratch.R10);
    TEST_ASSERT_EQUAL_UINT32(0u, state->LastRestoredTaskIrqScratch.R12);
    TEST_ASSERT_EQUAL_UINT32(OS_PORT_TMS570_FIQ_MINIMAL_FRAME_BYTES, state->LastRestoredTaskFrameBytes);
}

void test_Os_Port_Tms570_RegisterFiqResumeContextMetadataTests(void)
{
    RUN_TEST(test_Os_Port_Tms570_fiq_resume_uses_packed_restored_context_metadata_not_saved_frame_metadata);
}
