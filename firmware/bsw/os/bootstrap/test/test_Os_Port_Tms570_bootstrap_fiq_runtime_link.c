/**
 * @file    test_Os_Port_Tms570_bootstrap_fiq_runtime_link.c
 * @brief   FIQ runtime link-register tests for the TMS570 OS port
 * @date    2026-03-14
 */
#include "test_Os_Port_Tms570_bootstrap_support.h"

void test_Os_Port_Tms570_fiq_scheduler_return_captures_live_link_register(void)
{
    uint8 first_stack[160];
    uint8 second_stack[160];
    const Os_Port_Tms570_TaskContextType* first_ctx;
    uintptr_t outgoing_lr = (uintptr_t)0x77778888u;
...
{
    RUN_TEST(test_Os_Port_Tms570_fiq_scheduler_return_captures_live_link_register);
}
